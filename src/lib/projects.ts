...
export const authenticate = async (req: Request, res: Response, next: NextFunction) => {
  ...
  },
  {
    ...
    longDescription:
      "The ticketing system allows users to create, assign, and monitor tickets efficiently, with features like priority tagging, status updates, and user role management for improved workflow and communications.",
    technologies: ["NextJS", "TypeScript", "Tailwind CSS", "AuthJS", "Prisma", "Supabase", "PostgreSQL"],
    features: [
...
model VerificationToken {
  ...
  @@id([identifier, token])
    ...
    demoUrl: "https://github.com/Jenaide",
    githubUrl: "https://github.com/Jenaide",
  },
  {
